...
//    // МИНУС - это не удобно, когда нам нужна одинаковая логика обработки ошибок для всех контроллеров
    //           при таком подходе нам придется дублировать этот метод во всех контроллерах
//    @ExceptionHandler(ProductNotFoundException.class)
//    @ResponseStatus(HttpStatus.NOT_FOUND)
